            ...
            <div class="relative z-10 max-w-4xl mx-auto px-4">
                <div class="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                    ...
                    <div class="flex-shrink-0" data-aos="fade-right">
                        ...
                        @else
                            <div
                                class="h-32 w-32 rounded-full bg-white/20 border-4 border-white/20 flex items-center justify-center">
                                ...
                                <a href="{{ route('admin.contenus.show', $contenu) }}"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1 min-w-0">
                                            <h3
                                                class="font-semibold text-gray-900 group-hover:text-benin-green transition-colors duration-300 truncate">
                                                {{ $contenu->titre }}
                                            </h3>
                                        ...
                                        <svg class="w-5 h-5 text-gray-400 group-hover:text-benin-green transition-colors duration-300"
