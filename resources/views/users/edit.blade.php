        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden" data-aos="fade-up">
                <div class="benin-gradient px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @else
                                <div
                                    class="h-8 w-8 rounded-full bg-white/20 border border-white/20 flex items-center justify-center">
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="id_langue" name="id_langue" required
                                    ...
                                    @foreach ($langues as $langue)
                                        <option value="{{ $langue->id }}"
                                            {{ old('id_langue', $user->id_langue) == $langue->id ? 'selected' : '' }}>
                                            {{ $langue->nom_langue }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="statut" name="statut" required
                                    ...
                                    <option value="actif"
                                        {{ old('statut', $user->statut) == 'actif' ? 'selected' : '' }}>Actif</option>
                                    <option value="inactif"
                                        {{ old('statut', $user->statut) == 'inactif' ? 'selected' : '' }}>Inactif</option>
                                    <option value="en_attente"
                                        {{ old('statut', $user->statut) == 'en_attente' ? 'selected' : '' }}>En attente
                                    </option>
                                </select>
                                @error('statut')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <!-- Actions -->
                    <div
                        class="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-6 pt-6 border-t border-gray-200">
    ...
    <script>
        ...
        document.getElementById('photo').addEventListener('change', function(e) {
            ...
            `;
                    ...
                    document.getElementById('photo').parentNode.insertBefore(preview, document.getElementById(
                        'photo'));
                };
