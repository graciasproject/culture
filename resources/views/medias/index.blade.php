        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse($medias as $index => $media)
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover-lift group" data-aos="fade-up"
                        ...
                        <div class="relative h-48 bg-gray-200 overflow-hidden">
                            ...
                            @elseif($media->typeMedia->nom === 'vidéo')
                                <div
                                    class="w-full h-full bg-gradient-to-br from-benin-green to-benin-red flex items-center justify-center">
                            ...
                            @elseif($media->typeMedia->nom === 'audio')
                                <div
                                    class="w-full h-full bg-gradient-to-br from-benin-yellow to-orange-500 flex items-center justify-center">
                                    <svg class="w-16 h-16 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="absolute top-3 right-3">
                                <span
                                    class="bg-black/70 text-white px-2 py-1 rounded-full text-xs font-medium backdrop-blur-sm">
                                    {{ $media->typeMedia->nom }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-4">
                            ...
                            @if ($media->description)
                                <h3
                                    class="font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-benin-green transition-colors duration-300">
                                    {{ $media->description }}
                                </h3>
                            @else
